                    ...
                    <DropdownMenuContent align="end" className="w-72">
                        ...
                        <DropdownMenuItem className="py-3">
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-xs text-muted-foreground">Your investment in Green Palm Trees Farm is confirmed.</p>
                            </div>
                        </DropdownMenuItem>
                        <DropdownMenuItem className="py-3">
                            <div className="flex flex-col gap-1">
                                <p className="text-sm font-medium">ROI Payout</p>
                                <p className="text-xs text-muted-foreground">You received $500 ROI from Wheat Farm.</p>
                            </div>
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
