                ...
                <div className="flex items-center justify-between px-5 py-6 border-b border-sidebar-border">
                    <Link to="/" className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-foreground leading-tight">African Youth</span>
                            <span className="text-sm font-semibold text-primary leading-tight">Forum</span>
                        </div>
                    </Link>
